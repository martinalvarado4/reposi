...
from Tarea01 import jprogramones, jprogramonMoves, jroutes, jtypes, jmoveCategories, jgyms, jjugadoresEjemplo, inputCorrecto, inputCorrecto2
from Batallas import Batalla, Ataque
...
Menu:
	...
	def mover (self,jugador):
		...
		dirc = inputCorrecto("\nDesea avanzar ( 1 ) o retroceder ( 0 ):",1,1,0,0)
		if dirc == 1:
