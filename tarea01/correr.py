...
from ClasesT1 import jprogramones, jprogramonMoves, jroutes, jtypes, jmoveCategories, jgyms, jjugadoresEjemplo
from ClasesT1 import inputCorrecto, inputCorrecto2
class Batalla:
